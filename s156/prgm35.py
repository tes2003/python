class Rectangle:
    ...
    def __lt__(self,obj):
        if(self.area()<obj.area()):
             return"The area of the rectangle1 is less than rectangle2"
        else:
             return "The area of rectangle2 is less than the rectangle1"
print("RECTANGLE 1")
...
print(obj1.area())
print("RECTANGLE 2")
l=int(input("Enter the length of the rectangle2:"))
